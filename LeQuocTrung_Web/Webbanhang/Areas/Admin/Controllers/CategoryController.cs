    ...
    public class CategoryController : Controller
    {
        ...
        public ActionResult Index(string SearchString, string currentFilter, int? page)
        {
            ...
            if (!string.IsNullOrEmpty(SearchString))
            {
                ...
                lstCategory = objtrung_webEntities.Categories.Where(n => n.Name.Contains(SearchString)).ToList();
            }
            else
            {
                //lấy all sản phẩm trong bảng category
                lstCategory = objtrung_webEntities.Categories.ToList();
            }
        ...
        public ActionResult Create(Category objCategory)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    objtrung_webEntities.Categories.Add(objCategory);
        ...
        {
            var objCategory = objtrung_webEntities.Categories.Where(n => n.Id == Id).FirstOrDefault();
            return View(objCategory);
        }
        [HttpGet]
        ...
        {
            var objCategory = objtrung_webEntities.Categories.Where(n => n.Id == objCate.Id).FirstOrDefault();
            objtrung_webEntities.Categories.Remove(objCategory);
            objtrung_webEntities.SaveChanges();
            return RedirectToAction("Index");
        }
        [HttpGet]
        ...
        public ActionResult Edit(int id, Category objCategory)
        {
            if (ModelState.IsValid)
            {
                ...
                objtrung_webEntities.Entry(objCategory).State = System.Data.Entity.EntityState.Modified;
                objtrung_webEntities.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(objCategory);

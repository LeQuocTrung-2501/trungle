    ...
    public class BrandController : Controller
    {
        ...
        public ActionResult Index(string SearchString, string currentFilter, int? page)
        {
            ...
            if (!string.IsNullOrEmpty(SearchString))
            {
                ...
                lstBrand = objtrung_webEntities.Brands.Where(n => n.Name.Contains(SearchString)).ToList();
            }
            else
            {
                //lấy all sản phẩm trong bảng product
                lstBrand = objtrung_webEntities.Brands.ToList();
            }
        ...
        public ActionResult Create(Brand objBrand)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    objtrung_webEntities.Brands.Add(objBrand);
        ...
        {
            var objBrand = objtrung_webEntities.Brands.Where(n => n.Id == Id).FirstOrDefault();
            return View(objBrand);
        }
        [HttpGet]
        ...
        {
            var objBrand = objtrung_webEntities.Brands.Where(n => n.Id == objBra.Id).FirstOrDefault();
            objtrung_webEntities.Brands.Remove(objBrand);
            objtrung_webEntities.SaveChanges();
            return RedirectToAction("Index");
        }
        [HttpGet]
        ...
        public ActionResult Edit(int id, Brand objBrand)
        {
            if (ModelState.IsValid)
            {
                ...
                objtrung_webEntities.Entry(objBrand).State = System.Data.Entity.EntityState.Modified;
                objtrung_webEntities.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(objBrand);
